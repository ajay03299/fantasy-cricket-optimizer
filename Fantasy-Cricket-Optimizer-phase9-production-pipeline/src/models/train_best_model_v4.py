...
INPUT_PATH = Path("output/model_feature_table_v4.csv")
PREDICTIONS_PATH = Path("output/best_model_v4_predictions.csv")
...
def main():
    ...
    out = test_df.copy()
    out["predicted_fantasy_points_v4"] = preds
