...
INPUT_PATH = Path("output/player_match_fantasy_v0.csv")
OUTPUT_PATH = Path("output/player_match_fantasy_v0_with_opponent.csv")
...
def main():
    ...
    print("\nUnique teams per match distribution:")
    print(df.groupby("match_id")["team"].nunique().value_counts().sort_index())
