...
INPUT_PATH  = Path("output/model_feature_table_v9.csv")
OUTPUT_PATH = Path("output/best_model_v9_predictions.csv")
MODEL_DIR   = Path("models/v9")
...
def main():
    print("=" * 70)
    print("  FANTASY CRICKET OPTIMIZER v7 - PHASE MATCHUPS APPROACH")
    print("=" * 70)
