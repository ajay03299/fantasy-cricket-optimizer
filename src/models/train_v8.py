...
INPUT_PATH  = Path("output/model_feature_table_v8.csv")
OUTPUT_PATH = Path("output/best_model_v8_predictions.csv")
MODEL_DIR   = Path("models/v8")
...
def main():
    print("=" * 70)
    print("  FANTASY CRICKET OPTIMIZER v7 - MATCHUP FEATURES APPROACH")
    print("=" * 70)
    ...
    # ---- COMPARISON vs v6 ----
    print(f"\n{'='*70}")
    print("  FINAL COMPARISON - v8 vs v6")
    print(f"{'='*70}")
